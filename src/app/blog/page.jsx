      ...
      <div className="bg-white rounded-xl ">
        ...
        <div className="p-4 flex gap-4">
          ...
          <input
            ...
            className="  px-4 py-2 rounded flex-1  bg-amber-50 "
            value={search}
            onChange={(e) =>
          ...
          <select className="  px-3 py-2 rounded  bg-amber-50">
...
<table className="w-full table-fixed  -collapse">
  ...
  <thead className="bg-amber-50 ">
    ...
    <tr>
      ...
      <th className="p-4 w-[35%] text-left">
        Bài viết
      </th>

      <th className="p-4 w-[15%] text-left">
        Danh mục
      </th>
